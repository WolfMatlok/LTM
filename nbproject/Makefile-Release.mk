...
# Macros
CND_PLATFORM=GNU_4.9-Linux-x86
CND_DLIB_EXT=so
CND_CONF=Release
CND_DISTDIR=dist
CND_BUILDDIR=build
...
${OBJECTDIR}/cCGIHelper.o: cCGIHelper.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/boost -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cCGIHelper.o cCGIHelper.cpp

${OBJECTDIR}/cCSS.o: cCSS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/boost -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cCSS.o cCSS.cpp
...
${OBJECTDIR}/cHelperSerializer.o: cHelperSerializer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/boost -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cHelperSerializer.o cHelperSerializer.cpp
...
${OBJECTDIR}/cPlayerPool.o: cPlayerPool.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/boost -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cPlayerPool.o cPlayerPool.cpp

${OBJECTDIR}/cRendererCGI.o: cRendererCGI.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/boost -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cRendererCGI.o cRendererCGI.cpp

${OBJECTDIR}/cTournament.o: cTournament.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/boost -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cTournament.o cTournament.cpp

${OBJECTDIR}/cTournamentParameter.o: cTournamentParameter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/include/boost -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cTournamentParameter.o cTournamentParameter.cpp
