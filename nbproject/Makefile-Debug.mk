...
# CC Compiler Flags
CCFLAGS=-std=c++0x -lboost_program_options -lboost_serialization -lboost_filesystem -lboost_system -lcgicc
CXXFLAGS=-std=c++0x -lboost_program_options -lboost_serialization -lboost_filesystem -lboost_system -lcgicc
